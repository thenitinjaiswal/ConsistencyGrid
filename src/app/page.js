        ...
        */}
        <div className="mt-8 sm:mt-12 flex flex-col items-center justify-center px-4">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row w-full">
            ...
            <Link
              href="/pricing"
              className="w-full sm:w-auto inline-block text-center rounded-xl border-2 border-gray-200 bg-white px-8 py-4 text-base font-semibold text-gray-800 shadow-sm hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
            >
              View Pricing
            </Link>
          </div>
