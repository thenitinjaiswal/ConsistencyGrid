...
/**
 * Public Wallpaper - Full Canvas with Live Data
 * 
 * Shows the complete wallpaper rendering with all live data:
 * - Real-time updates
 * - All habit/goal information
 * - Complete visualization
 */

export default function FullCanvasWallpaperClient({
  token,
  settings: s,
  ageYears,
  lifeProgress,
      ...
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-[#0a0a0a] backdrop-blur-xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-white/10 bg-white/5">
          <p className="text-xs text-center text-gray-500">
            🎨 Canvas-rendered • All live data • Real-time updates
          </p>
        </div>
